...
function Badge({ label, icon: Icon }) {
  return (
    <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-[0.18em] mb-5 bg-[rgba(0,200,255,0.07)] border border-[rgba(0,200,255,0.2)] text-[#00c8ff]">
...
function StatCard({ stat, index }) {
  ...
  return (
    <motion.div ref={ref}
      ...
      className="flex flex-col items-center text-center px-4 py-5 rounded-2xl relative overflow-hidden group"
      ...
      <StatIcon size={18} className="mb-2 opacity-60" style={{ color: '#00c8ff' }} />
...
function ServiceCard({ service, index, isActive }) {
  ...
  return (
    <motion.article
      ...
      className="group relative h-full rounded-[2.5rem] flex flex-col cursor-pointer overflow-hidden border border-white/[0.06] hover:border-white/[0.14] transition-colors"
      style={{
      ...
      <div className="relative aspect-video overflow-hidden">
        ...
        <div className="absolute bottom-5 left-6">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:rotate-[15deg] group-hover:shadow-[0_0_30px_rgba(0,200,255,0.2)]"
            style={{
...
/* ── Form field ── */
const inputCls = (err) => [
  'w-full px-4 py-3.5 rounded-xl text-sm transition-all duration-250 outline-none font-medium',
  'bg-[rgba(5,13,26,0.8)] border text-white placeholder-[#2e4a6a] focus:ring-0',
  err
    ? 'border-red-500/50 focus:border-red-400 shadow-[0_0_0_3px_rgba(239,68,68,0.07)]'
    : 'border-white/[0.08] hover:border-white/[0.16] focus:border-[rgba(0,200,255,0.45)] focus:shadow-[0_0_0_3px_rgba(0,200,255,0.07)]',
].join(' ');
...
const Service = () => {
  ...
  return (
    <PageWrapper className="bg-[#050d1a]">
      {/* ─── § 1 HERO ─── */}
      <section className="relative flex items-start overflow-hidden pt-2 lg:pt-4 pb-12 px-6 lg:px-12">
        {/* Background layers */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-[60vw] h-full opacity-[0.15]"
            style={{ background: 'radial-gradient(ellipse at left center, rgba(0,200,255,0.3) 0%, transparent 70%)' }} />
          <div className="absolute top-0 right-0 w-[50vw] h-full opacity-[0.1]"
            style={{ background: 'radial-gradient(ellipse at right top, rgba(124,58,237,0.4) 0%, transparent 70%)' }} />
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start lg:pl-6">
            ...
            <motion.p initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
              className="text-[#94a3b8] leading-relaxed mb-8 max-w-[500px] text-base lg:text-lg">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6, duration: 1 }}
              ...
              {STATS.map((stat, i) => (
                <div key={stat.label} className="flex flex-col">
                  <span className="text-white font-black text-2xl lg:text-3xl mb-1">{stat.value}</span>
                  <span className="text-[#64748b] text-[10px] font-bold uppercase tracking-widest">{stat.label}</span>
                </div>
              ))}
            </motion.div>
          </div>
      ...
      <section className="pt-0 pb-24 px-5 relative overflow-hidden" id="services-grid">
        <div className="max-w-[1400px] mx-auto relative z-10 text-center mb-16">
          <FadeUp>
            <Badge label="Engineering Pillars" />
            <h2 className="font-['Space_Grotesk'] font-black text-white leading-tight tracking-tight mb-4" style={{ fontSize: 'clamp(2.5rem,4vw,3.5rem)' }}>
              Enterprise-Grade{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00c8ff] to-[#7c3aed]">Capability</span>
            </h2>
            <p className="text-[#6b87a8] text-base lg:text-lg leading-relaxed max-w-2xl mx-auto">
          ...
          <FadeUp>
            <div className="text-center mb-14">
              ...
              <h2 className="font-['Space_Grotesk'] font-black text-white tracking-tight mb-4" style={{ fontSize: 'clamp(2.2rem,4.5vw,3.2rem)' }}>
                Why Choose{' '}
                <span style={{ background: 'linear-gradient(135deg,#00c8ff,#7c3aed)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Our Services</span>
              </h2>
              <p className="text-[#6b87a8] max-w-xl mx-auto text-base leading-relaxed">We don't just write code — we build technology partnerships that last decades.</p>
            </div>
          </FadeUp>
              ...
              return (
                <FadeUp key={item.title} delay={i * 0.1}>
                  <motion.div whileHover={{ y: -6 }} transition={{ type: 'spring', stiffness: 280 }}
                    className="group relative rounded-2xl p-7 border border-white/[0.06] hover:border-white/[0.12] transition-all duration-400 h-full overflow-hidden"
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <FadeUp>
            <div className="text-center mb-16">
              ...
              <h2 className="font-['Space_Grotesk'] font-black text-white tracking-tight mb-4" style={{ fontSize: 'clamp(2.2rem,4.5vw,3.2rem)' }}>
                How We{' '}
                <span style={{ background: 'linear-gradient(135deg,#00c8ff,#7c3aed)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Work</span>
              </h2>
              <p className="text-[#6b87a8] max-w-xl mx-auto text-base leading-relaxed">A proven, repeatable delivery framework that minimises risk and maximises velocity.</p>
            </div>
          </FadeUp>
                ...
                return (
                  <FadeUp key={step.step} delay={i * 0.1}>
                    <motion.div whileHover={{ y: -8 }} transition={{ type: 'spring', stiffness: 300 }}
                      ...
                      <div className="relative">
                        <div className="w-[100px] h-[100px] rounded-3xl flex flex-col items-center justify-center gap-1.5 border transition-all duration-400 relative z-10"
                          style={{ background: `rgba(${rgb},0.06)`, borderColor: `rgba(${rgb},0.2)`, backdropFilter: 'blur(12px)' }}>
                          <span className="text-[10px] font-black font-mono tracking-[0.2em]" style={{ color: step.color }}>{step.step}</span>
        ...
        <div className="max-w-3xl mx-auto">
          <FadeUp>
            <div className="text-center mb-12">
              ...
              <h2 className="font-['Space_Grotesk'] font-black text-white tracking-tight mb-4" style={{ fontSize: 'clamp(2.2rem,4.5vw,3.2rem)' }}>
                Start Your{' '}
                <span style={{ background: 'linear-gradient(135deg,#00c8ff,#7c3aed)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Project</span>
              </h2>
              <p className="text-[#6b87a8] max-w-md mx-auto text-base leading-relaxed">Tell us about your requirements. We'll respond within 24 hours with a tailored proposal.</p>
            </div>
          </FadeUp>
          <FadeUp delay={0.15}>
            <div className="relative rounded-3xl overflow-hidden"
              style={{ background: 'rgba(10,22,40,0.88)', border: '1px solid rgba(0,200,255,0.1)', backdropFilter: 'blur(28px)' }}>
              <div className="absolute top-0 left-0 right-0 h-[2px]"
                style={{ background: 'linear-gradient(90deg,transparent,rgba(0,200,255,0.7),rgba(124,58,237,0.6),transparent)' }} />
